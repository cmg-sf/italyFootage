...
class App extends Component {
  ...
  search(e){
    e.preventDefault();
    window.location.assign(`https://stockfootage.com/?s=italy+${this.state.search}&post_type=product`);
  }
  render() {
    return (
      <div className="App">
        ...
        <div id="vidtop-content">
          ...
          <div className="interact-box">
            <img src={logo} alt=""/>
            <h1><span style={{color: 'rgb(188, 52, 38)'}}>Italy</span>Footage.com</h1>
        ...
        <div className="info-sec">
          <section>
            <h1>Italy <a className="rf" href="https://en.wikipedia.org/wiki/Royalty-free">Royalty-Free</a> Stock Footage Marketplace (contact us for 4K)</h1>
            <h4 className="sub-banner">ItalyFootage.com is a division of <a style={{textDecoration:'none', color: '#999'}} href="https://stockfootage.com/">StockFootage.com</a></h4>
          </section>
          ...
          <section className="category-sec">
            ...
            <div className="categories">
						...
						<a href="https://stockfootage.com/?s=italy+Grand+Canal&post_type=product" className="cat">Grand Canal</a>
						<a href="https://stockfootage.com/?s=italy+Gondolas&post_type=product" className="cat">Gondolas</a>
						<a href="https://stockfootage.com/?s=italy+Rialto+Bridge.+St.+Marcos+Square&post_type=product" className="cat">Rialto Bridge. St. Marcos Square</a>
						<a href="https://stockfootage.com/?s=italy+Vatican+museum+and+square&post_type=product" className="cat">Vatican museum and square</a>
						<a href="https://stockfootage.com/?s=italy+Sistine+Chapel&post_type=product" className="cat">Sistine Chapel</a>
						<a href="https://stockfootage.com/?s=italy+St.+Peter's+Cathedral&post_type=product" className="cat">St. Peter's Cathedral</a>
						<a href="https://stockfootage.com/?s=italy+Colosseum&post_type=product" className="cat">Colosseum</a>
						<a href="https://stockfootage.com/?s=italy+Spanish+Steps&post_type=product" className="cat">Spanish Steps</a>
						<a href="https://stockfootage.com/?s=italy+Altare+della+Patria&post_type=product" className="cat">Altare della Patria</a>
